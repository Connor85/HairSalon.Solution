...
namespace HairSalon.Tests
{
  ...
  public void Edit_UpdatesClientInDatabase_String()
  {
   ...
   Client testClient = new Client (firstDescription,firstAppointment,firstStylistId);
   testClient.Save();
   ...
   string result = Client.Find(testClient.id);
  ...
  public void Delete_DeleteClientInDatabase()
  {
   ...
   int count = Category.Find(1).GetClients().Count;
